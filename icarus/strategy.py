...
from icarus.logging import LinkLogger, CacheLoggerNew, CacheLogger, DelayLogger, StretchLogger, \
...
class BaseStrategy(object):
    ...
    def close(self):
        ...
        CacheHitRatioSummary(self.log_dir).write_summary(self.scenario_id, self.cache_logger_new.cache_hit_ratio_new())
